...
How the month went, with the trend, where time leaked and what improved.
...
## Where the time went
```dataviewjs
await dv.view("08_Meta/Work-Style/views/insights", { range: "report", show: ["categories"] })
```

## Delivery and estimates
```dataviewjs
await dv.view("08_Meta/Work-Style/views/insights", { range: "report", show: ["ledger", "estimates"], limit: 30 })
```

## Wins
```dataviewjs
await dv.view("08_Meta/Work-Style/views/insights", { range: "report", show: ["wins"], limit: 25 })
```

## Learning and skills
```dataviewjs
await dv.view("08_Meta/Work-Style/views/insights", { range: "report", show: ["learning", "skills"] })
```
